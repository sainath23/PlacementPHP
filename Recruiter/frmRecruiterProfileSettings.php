<?php
	...
	$getStudentByID = mysqli_query($con, "SELECT * FROM tbl_recruiteraccountdetails WHERE username='$id'");
...
<head>
<meta charset="utf-8">
<title>Recruiter profile settings</title>
...
<div id="innersection">
<form action="act_recruiter_update_settings.php" method="post" name="UpdateProfile">
