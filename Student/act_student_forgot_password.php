<?php
    ...
    $sql = mysqli_query($con, "SELECT * FROM tbl_jobseekerregistration  WHERE JobSeekerID='$username' AND Answer='$answer' AND HintQuestion='$question'");
	...
	{
		header("Location: frmStudentForgotPassword.php?msg=2");
	}
