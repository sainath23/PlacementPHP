...
<form action="act_admin_add_country.php" method="post" name="AddCountry">
<table border="0" align="center">
  <tbody>
    <tr>
      <td><label for="txtCountryName"><strong>Country Name:</strong></label></td>
      <td>
        <input type="text" name="txtCountryName" id="txtCountryName"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2"><input type="checkbox" name="checkbox" id="checkbox">
        <label for="checkbox">Country Info (Check the check option to view existed data.)</label></td>
    </tr>
    <tr>
