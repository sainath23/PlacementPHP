...
<table style="margin-left:auto; margin-right:auto; text-align:center">
	...
	$sql = mysqli_query($con, "SELECT * FROM tbl_jobseekeracademicdetails ORDER BY EnrollmentNo ASC");
    ...
    <tr style="background-color:<?php echo $rowColor ?>;">
      ...
      <td class="labels" style="text-align:center;"><a href="edit-student.php?ID=<?php echo $row['JobSeekerID']; ?>">Edit</a> | <a href="delete-student.php?ID=<?php echo $row['JobSeekerID']; ?>">Delete</a></td>
    </tr>
	<?php
	$rowCount ++;
	}
