...
<head>
<meta charset="utf-8">
<title>Admin - Offered Jobs By Company</title>
...
<div id="innersection">
<h3 align="center">All Offered Jobs</h3>
<table style="margin-left:auto; margin-right:auto; font-size:14px; text-align:center;">
	...
	$sql = mysqli_query($con, "SELECT * FROM tbl_recruiterresponsetojobseeker ORDER BY JobID ASC");
