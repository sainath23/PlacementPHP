...
<head>
<meta charset="utf-8">
<title>Admin - View All Job Types</title>
...
<div id="innersection">
<h3 align="center">All Posted Types of Jobs</h3>
<table style="margin-left:auto; margin-right:auto; text-align:center">
	...
	$sql = mysqli_query($con, "SELECT * FROM tbl_jobtype_master ORDER BY JobId ASC");
    ...
    <tr style="background-color:<?php echo $rowColor ?>;">
      ...
      <td class="labels" style="text-align:center;"><a href="edit-job-type.php?ID=<?php echo $row['JobId']; ?>">Edit</a> | <a href="delete-job-type.php?ID=<?php echo $row['JobId']; ?>">Delete</a></td>
    </tr>
	<?php
	$rowCount ++;
	}
