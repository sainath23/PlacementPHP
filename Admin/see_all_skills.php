...
<div id="innersection">
<h3 align="center">All Posted Skill Types</h3>
<table style="margin-left:auto; margin-right:auto; text-align:center">
	<tr style="background-color:#ccc; text-align:center;">
      <td style="width:170px;"><strong>Skill Type</strong></td>
	...
	$sql = mysqli_query($con, "SELECT * FROM tbl_skill_master ORDER BY SkillId ASC");
    ...
    <tr style="background-color:<?php echo $rowColor ?>;">
      ...
      <td class="labels" style="text-align:center;"><a href="edit-qualification.php?ID=<?php echo $row['SkillId']; ?>">Edit</a> | <a href="delete-qualification.php?ID=<?php echo $row['SkillId']; ?>">Delete</a></td>
    </tr>
	<?php
	$rowCount ++;
	}
