...
<div id="innersection">
<h3 align="center">All Posted Eligibility Criteria</h3>
<table style="margin-left:auto; margin-right:auto; text-align:center">
	<tr style="background-color:#ccc; text-align:center;">
      <td style="width:170px;"><strong>Qualification</strong></td>
	...
	$sql = mysqli_query($con, "SELECT * FROM tbl_qualification ORDER BY QualificationId ASC");
    ...
    <tr style="background-color:<?php echo $rowColor ?>;">
      ...
      <td class="labels" style="text-align:center;"><a href="edit-qualification.php?ID=<?php echo $row['QualificationId']; ?>">Edit</a> | <a href="delete-qualification.php?ID=<?php echo $row['QualificationId']; ?>">Delete</a></td>
    </tr>
	<?php
	$rowCount ++;
	}
